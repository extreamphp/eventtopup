...
include 'inc/connection.php' ;
	...
	if ($playerpoint>=50){
		...
		$sqllogs = "
				...
				VALUES (NULL, '$account_id ', 'Event', 'Open event box', NOW());
				" ;
	...
	echo "<br>";
			...
			echo $check; echo "<br>";
				if($random<$check){
					...
					// Add logs 
						$sqllogs2 = "
						INSERT INTO `logs` (`logs_id`, `account_id`, `logs_type`, `logs_desc`, `logs_date`) 
						VALUES (NULL, '$account_id ', 'Event', 'Congratulation! you just got a $itemname ', NOW());
						" ;
		...
		$sqllogs3 = "
				INSERT INTO `logs` (`logs_id`, `account_id`, `logs_type`, `logs_desc`, `logs_date`) 
				VALUES (NULL, '$account_id ', 'Event', 'Sorry ... you got notthing from EMPTY BOX ', NOW());
				" ;
